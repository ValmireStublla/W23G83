...
namespace Pharmacy_app.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Adress,Msg")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Adress,Msg")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
